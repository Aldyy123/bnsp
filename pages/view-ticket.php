        ...
        <div class="col-md-8 offset-md-2">
            <div class="card p-2">
                <form action="../controllers/new-passanger.php" method="POST">
                    <div class="form-group d-flex justify-content-between m-2 flex-column flex-md-row">
                    ...
                    <div class="form-check d-flex justify-content-between m-2 flex-column flex-md-row">
